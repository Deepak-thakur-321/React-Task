...
import { addItem, removeItem } from "../components/redux/Slice";
   ...
   return (
      <div>
         ...
         <div className="px- mt-1">
            <div className="rounde overflow-hidden shadow-2xl bg-slate-50">
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:h-[500px]">

                  {/* Left Section- 8 columns */}
                  <div className="lg:col-span-8 bg-[rgb(222,231,236)] rounded px-5 borde">
                  ...
                  <div className="lg:col-span-4">
                     <div className="flex flex-col items-center gap-3">
                        ...
                        <img
                           ...
                           alt="Fashion Model"
                           className="w-11/12 lg:w-full max-h-[300px] object-cover rounded shadow-xl"
                        />
